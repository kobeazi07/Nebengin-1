            ...
            <div class="col-lg-12 grid-margin2 stretch-card">
              <div class="card">
                ...
                @php
                   $i = 0
                  @endphp
                @foreach( $riwayatpickuptrip as $key=>$trips )
                ...
                      <tr>
                        ...
                        <a href="{{route('DetailRiwayatPickupTrip', $trips->id)}}"> <button  class="btn btn-success btn-sm" >   <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-eye-fill" viewBox="0 0 16 16">
