            ...
            <div class="col-lg-12 grid-margin2 stretch-card">
              <div class="card">
                ...
                <div class="modal" id="myModal">
                  <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                      ...
                      <form action="{{route('TambahTrip')}}" method="POST">
                          @csrf
                        <div class = "row">
                        ...
                        <label>Maksimum Kapasitas</label>
                          ...
                          <div class = "col-lg-6"> 
                            ...
                            <div class = "form-group">
                              ...
                              <select class = "form-control js-example-basic-single w-100" name="kendaraans_id">
                            ...
                            <div class ="form-group">
                              <label>Rute</label>
                              <select class= "form-control js-example-basic-single w-100" name="tarifs_id">
                        ...
                        <div class = "form-group">
                            <label>Catatan</label>
                            <textarea class = "form-control" style = "height:100px;" placeholder="Catatan" name="catatan"></textarea>
                          </div>
                      </div>
                ...
                      <tr> 
                        ...
                        <td>
                        <a href="{{route('HalamanDetailTrip', $trips->id)}}"> <button  class="btn btn-success btn-sm" >   <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-eye-fill" viewBox="0 0 16 16">
                          <path d="M10.5 8a2.5 2.5 0 1 1-5 0 2.5 2.5 0 0 1 5 0z"/>
                          <path d="M0 8s3-5.5 8-5.5S16 8 16 8s-3 5.5-8 5.5S0 8 0 8zm8 3.5a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7z"/>
                        </svg></button></a> 
                                                <a type="button" class = "btn btn-warning btn-sm" data-toggle="modal" data-target="#EditTrip-{{$trips->id}}">
                    ...
                    <div
                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                <form action="{{route('EditTrip',$trips->id)}}" method="POST">
                          @csrf
                        <div class = "row">
                        ...
                        <div class ="form-group">
                        <label>Jam Keberangkatan</label>
                         <input type = "time" class="form-control" name="jam_keberangkatan" value="{{$trips->jam_keberangkatan}}">
                         </div>
                        <div class ="form-group">
                        <label>Maksimum Kapasitas</label>
                          ...
                          <div class = "col-lg-6">
                            ...
                            <div class = "form-group">
                              ...
                              <select class = "form-control js-example-basic-single w-100" name="kendaraans_id"  value="{{$trips->kendaraans_id}}">
                              @foreach( $datakendaraan as $kendaraam)
                                <option value="{{$kendaraam->id}}">{{$kendaraam->nama_tipe}}</option>
                                @endforeach
                              </select>
                            ...
                            <div class ="form-group">
                              <label>Rute</label>
                              <select class= "form-control js-example-basic-single w-100" name="tarifs_id"  value="{{$trips->tarifs_id}}">
                        ...
                        <div class = "form-group">
                            <label>Catatan</label>
                            <textarea class = "form-control" style = "height:100px;" placeholder="Catatan" name="catatan"   value="{{$trips->catatan}}" required></textarea>
                          </div>
                      </div>
